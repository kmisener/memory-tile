$('document').ready(function(){
    ...
    $('#menu .deck').click(memory.deckSelected);
    $('#menu .deck').click(memory.shuffle);
});
...
var memory = (function() {
  ...
  var arrays = {
          ...
          breakingBad: ['assets/img/breakingBad/breakingBad_addict', 'assets/img/breakingBad/breakingBad_addict',
              'assets/img/breakingBad/breakingBad_brotherInLaw', 'assets/img/breakingBad/breakingBad_brotherInLaw',
              'assets/img/breakingBad/breakingBad_camper', 'assets/img/breakingBad/breakingBad_camper',
              'assets/img/breakingBad/breakingBad_combo', 'assets/img/breakingBad/breakingBad_combo',
              'assets/img/breakingBad/breakingBad_gale', 'assets/img/breakingBad/breakingBad_gale',
              'assets/img/breakingBad/breakingBad_Gus', 'assets/img/breakingBad/breakingBad_Gus',
              'assets/img/breakingBad/breakingBad_Hector', 'assets/img/breakingBad/breakingBad_Hector',
              'assets/img/breakingBad/breakingBad_Heisenberg', 'assets/img/breakingBad/breakingBad_Heisenberg',
              'assets/img/breakingBad/breakingBad_Jesse', 'assets/img/breakingBad/breakingBad_Jesse',
              'assets/img/breakingBad/breakingBad_mike', 'assets/img/breakingBad/breakingBad_mike',
              'assets/img/breakingBad/breakingBad_saul', 'assets/img/breakingBad/breakingBad_saul',
              'assets/img/breakingBad/breakingBad_skinnyPete', 'assets/img/breakingBad/breakingBad_skinnyPete',
              'assets/img/breakingBad/breakingBad_skyler', 'assets/img/breakingBad/breakingBad_skyler',
              'assets/img/breakingBad/breakingBad_Todd', 'assets/img/breakingBad/breakingBad_Todd',
              'assets/img/breakingBad/breakingBad_tuco', 'assets/img/breakingBad/breakingBad_tuco',
          ]
      };//end arrays
      ...
      function changeBackground() {
        ...
        switch(deck) {
          ...
          case 'breakingBad':
            $('[id^=card_]').css('background-image', 'url(assets/img/breakingBad/breakingBadLogo.jpg)');
            cardBackGround = 'assets/img/breakingBad/breakingBadLogo.jpg';
            break;
        } // End Switch
      ...
      function shuffle() {
              ...
              //Remove memory-board background image and change background to black
              $('#memory-board').css('background', 'black');
          } //End Shuffle
